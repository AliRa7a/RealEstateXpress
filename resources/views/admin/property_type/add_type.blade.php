                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{route('admin.update.password')}}" class="forms-sample">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="type_name" id="type_name" autocomplete="off">
                                </div>
                                <div class="mb-3">
                                    <label for="type_icon" class="form-label">Type Icon</label>
                                    <input type="file" class="form-control" name="type_icon" id="type_icon" autocomplete="off">
                                </div>
